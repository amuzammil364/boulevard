...
<main class="p-4 sm:ml-64 md:ml-64 h-auto pt-20">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 py-4">
        ...
        <div class="w-full md:w-auto flex items-center flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
            ...
            <form action="{{ route("sendReminderMail") }}" method="POST">
                @csrf
                <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Maintenance Reminder</button>
            </form>
        </div>
    </div>
            ...
            <div class="filters">
                <form action="{{ route("payments") }}" method="GET" class="space-y-4 mb-5">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2 md:grid-cols-2">
                        ...
                        <div class="col-span-1 sm:col-span-1">
                            <input type="number" name="receipt_id" id="receipt_id" value="{{ $filters->receipt_id }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Receipt Id">
                        </div>
