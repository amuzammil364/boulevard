...
<main class="p-4 sm:ml-64 md:ml-64 h-auto pt-20">
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-4">
        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <a href="{{ url("/dashboard/users") }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                View more
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h3 class="font-bold text-3xl mb-2">Products</h3>
            <p class="">This is a list of latest products</p>
        </div>
    </div>
