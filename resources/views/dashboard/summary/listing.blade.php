...
<main class="p-4 sm:ml-64 md:ml-64 h-auto pt-20" id="main">
    ...
    <form action="{{ route("summary") }}" method="GET" class="space-y-4 mb-5">
        @csrf
        <div class="grid gap-4 mb-4 grid-cols-2 md:grid-cols-3">
    ...
    <p style="margin-top: 20px;" class="w-full md:w-full py-6 px-6 text-md text-gray-700 uppercase bg-white dark:bg-gray-700 dark:text-gray-400 shadow-md sm:rounded-lg"><b>Cash in Hand : {{ $paid_collection_types_total_amount +  $collection_types_total_amount_arrears - $expenses_types_total_amount }}</b></p>
    </div>
