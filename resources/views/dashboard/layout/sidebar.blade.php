    ...
    <aside id="default-sidebar" class="pt-14 fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
        <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <ul class="space-y-2">
                ...
                @if (Session::has("role_id") && Session::get("role_id") == 1)
                <li>
                    <button class="flex items-center justify-between w-full p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                        <div class="flex items-center">
                            <img class="h-auto" width="20" src="{{URL::asset('/icons/expenses.png')}}" alt="image description">
                            <span class="ml-3">Expense</span>
                        </div>
                        <svg aria-hidden="true" class="w-5 h-5" fill="#111827" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </button>
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ url("/dashboard/expenses") }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Expenses</a>
                        </li>
                        <li>
                            <a href="{{ url("/dashboard/expense-types") }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Expense Types</a>
                        </li>
                    </ul>
                </li>
                <!-- <li>
                ...
                <li>
                    <a href="{{ url("/dashboard/reports") }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <img class="h-auto" width="20" src="{{URL::asset('/icons/transactions.png')}}" alt="image description">
